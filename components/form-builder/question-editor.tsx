	...
	return (
		<div className="p-4 space-y-6">
			...
			<div className="flex items-center gap-2">
				{typeInfo && <typeInfo.icon className="w-4 h-4 text-lavender-dark" />}
				...
				<div>
					...
					<div className="flex items-center gap-4">
						<div className="flex-1">
							<Label htmlFor="minValue" className="text-xs text-slate-500">
								Min
							</Label>
							<Input
								id="minValue"
								...
								onChange={(e) =>
									onUpdate({ minValue: parseInt(e.target.value) || 1 })
								}
								min={1}
								max={4}
								className="mt-1"
						...
						<div className="flex-1">
							<Label htmlFor="maxValue" className="text-xs text-slate-500">
								Max
							</Label>
							<Input
								id="maxValue"
								...
								onChange={(e) =>
									onUpdate({ maxValue: parseInt(e.target.value) || 5 })
								}
								min={2}
								max={10}
								className="mt-1"
					...
					<div className="flex items-center gap-4">
						...
						<div className="flex-1">
							...
							<Input
								...
								onChange={(e) =>
									onUpdate({ maxValue: parseInt(e.target.value) || 10 })
								}
								min={5}
								max={10}
								className="mt-1"
